...
module.exports = {
    ...
    body: p => `
      ...
      ${p.at /* parametric position */}   
        ...
        (fp_text reference REF** (at -5.9 5.2) (layer Dwgs.User)
        ...
        (fp_line (start -1.33 11.49) (end 1.33 11.49) (layer Dwgs.User) (width 0.12))
        (fp_line (start -1.33 1.27) (end -1.33 11.49) (layer Dwgs.User) (width 0.12))
        (fp_line (start 1.33 1.27) (end 1.33 11.49) (layer Dwgs.User) (width 0.12))
        (fp_line (start -1.33 1.27) (end 1.33 1.27) (layer Dwgs.User) (width 0.12))
        (fp_line (start -1.33 0) (end -1.33 -1.33) (layer Dwgs.User) (width 0.12))
        (fp_line (start -1.33 -1.33) (end 0 -1.33) (layer Dwgs.User) (width 0.12))
        ...
        (fp_line (start 4.5 12.5) (end 4.5 17.5) (layer Dwgs.User) (width 0.12))
        (fp_line (start 4.5 17.5) (end 20.5 17.5) (layer Dwgs.User) (width 0.12))
        (fp_line (start -1.5 -2.6) (end 4.5 -2.6) (layer Dwgs.User) (width 0.12))
        (fp_line (start 4.5 -7.6) (end 20.5 -7.6) (layer Dwgs.User) (width 0.12))
        (fp_line (start 4.5 -2.6) (end 4.5 -7.6) (layer Dwgs.User) (width 0.12))
        (fp_line (start 20.5 17.5) (end 20.5 -7.6) (layer Dwgs.User) (width 0.12))
