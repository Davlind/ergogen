module.exports = {
    ...
    body: p => {
        ...
        function tracks(def_side) {
            return `
                ${'' /* ring to diode */}
                (pad "" smd custom (at 3.81 0 ${p.rot}) (size 0.25 0.25) (layers ${def_side}.Cu) ${p.net.from.str}
                (zone_connect 0)
                ...
                ${'' /* square to diode */}
                (pad "" smd custom (at -3.81 0 ${p.rot}) (size 0.25 0.25) (layers ${def_side}.Cu) ${p.net.to.str}
                (zone_connect 0)
                (options (clearance outline) (anchor circle))
                (primitives
                    (gr_line (start 0 0) (end 2.16 0) (width 0.25))
