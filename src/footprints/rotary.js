...
module.exports = {
    ...
    body: p => `
        (module rotary_encoder (layer F.Cu) (tedit 603326DE)
            ...
            ${'' /* footprint reference */}
            (fp_text reference "${p.ref}" (at 0 0.5) (layer Dwgs.User) 
            ...
            (fp_line (start -7.32 -4.14) (end -7.62 -3.84) (layer Dwgs.User) (width 0.12))
            (fp_line (start -7.92 -4.14) (end -7.32 -4.14) (layer Dwgs.User) (width 0.12))
            (fp_line (start -7.62 -3.84) (end -7.92 -4.14) (layer Dwgs.User) (width 0.12))
